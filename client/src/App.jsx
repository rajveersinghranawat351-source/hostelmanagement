...
export default function App() {
  ...
  // 1. Role Selection Screen (when no portal role is chosen)
  if (!activeRole) {
    return (
        ...
        <main className="max-w-md mx-auto my-auto p-6 bg-slate-800 rounded-3xl border border-slate-700 text-center shadow-2xl">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full py-3 px-4 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-sm transition cursor-pointer"
            >
